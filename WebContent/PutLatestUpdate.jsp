...
<div id="tooplate_header">
 ...
 <form action="PutLatestUpdate.jsp" method="get">
<table><tr><td><b><h4>Enter Update Title:</h4></b></td><td><input type="text" size=52 name="titl"></td></tr><br>
<tr><td><strong><h4>Enter update Description:</h4></strong></td><td><textarea name="desc" cols=38 rows=7></textarea></td></tr></table>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<br>
