...
<div id="tooplate_header">
    ...
    <div id="tooplate_mid_wrapper">
      ...
      <div  class="form">
    		<form id="contactform" action='control' method='get'>
    		<h4>Member signup </h4> 
                ...
                <p class="contact"><label for="id">Create a id</label></p> 
    			<input id="username" name="id" placeholder="id" required tabindex="2" type="text"> 
   ...
   <br />
   <a href="advsignup.jsp"><h5>Want to advertise....just sign up here</h5></a>
</div>      
</div>
