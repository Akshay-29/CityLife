...
<title>Orange Bond - Contact</title>c
    ...
    <div id="tooplate_titlebar">
        ...
        <div id="tooplate_menu" class="ddsmoothmenu">
          ...
          <li><a href="about.html">Login</a>
              ...
              <li><a href="blog.html">Suggetions</a></li>
              <li><a href="suggetions.html" class="selected">Qwery&amp;Chat</a>
              </li>
                 
                 <li><a href="Qwery&Chat.html" class="selected">About Us</a>
                 </li>
...
<div id="tooplate_main"><p><img src="images/user.jpg" alt="Image usre" width="85" height="74" title="Donec sit amet gravida quam ut condimentum risus." /></p>
  ...
  <% 
String name=application.getAttribute("hanisha").toString();
  ...
  <div class="col_2 float_l">
    ...
    <div class="col_2 float_r">
        ...
        <a href="images/map.jpg" rel="lightbox" title="Our Location"><img src="images/map.jpg" alt="Our Location" /></a></div>
        <div class="cleaner h20"></div>
            <h3>Mailing Address</h3>
            <h5>Company Name</h5>
            200-400 Nulla aliquam dictum, <br />
            Etiam a nulla ligula, 10140<br />
