...
<title>Orange Bond - Portfolio</title>
    ...
    <div id="tooplate_titlebar">
        ...
        <div id="tooplate_menu" class="ddsmoothmenu">
            <ul>
              ...
              <li><a href="portfolio.jsp">Suggestion</a></li>
              <li><a href="cot.jsp">Query & Chat</a></li>
    	...
    	<div id="midle_title"><h1>&nbsp;</h1>
    	  <h1>Must Visiting Place</a>s According Months</h1>
    	</div>
        
        <ul>
        <li><a href="january.jsp">January</a></li>
        <li><a href="february.jsp">February</a></li>
        <li><a href="march.jsp">March</a></li>
        <li><a href="april.jsp">April</a></li>
        <li><a href="may.jsp">May</a></li>
        <li><a href="june.jsp">June</a></li>
        <li><a href="july.jsp">July</a></li>
        <li><a href="august.jsp">August</a></li>
        <li><a href="september.jsp">September</a></li>
        <li><a href="october.jsp">October</a></li>
        <li><a href="november.jsp">November</a></li>
        <li><a href="december.jsp">December</a></li>
